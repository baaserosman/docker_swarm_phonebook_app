...
cd /home/ec2-user
git clone ${git-repo}
sed -i "s|phonebook_image|${image-repo}|" /home/ec2-user/docker_swarm_phonebook_app/docker-compose.yaml
docker stack deploy --with-registry-auth -c /home/ec2-user/docker_swarm_phonebook_app/docker-compose.yaml phonebook